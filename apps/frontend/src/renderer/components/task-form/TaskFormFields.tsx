...
import type { PhaseModelConfig, PhaseThinkingConfig, PhaseModelConfigV3 } from '../../../shared/types/settings';
...
interface TaskFormFieldsProps {
  ...
  onPhaseModelsV3Change?: (config: PhaseModelConfigV3) => void;
  ...
  return (
    <div className="space-y-6">
      ...
      <AgentProfileSelector
        ...
        onPhaseModelsV3Change={onPhaseModelsV3Change}
