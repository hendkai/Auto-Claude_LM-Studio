...
export type TaskStatus = 'backlog' | 'queue' | 'in_progress' | 'ai_review' | 'human_review' | 'pr_created' | 'done' | 'error';
...
export interface TaskMetadata {
  ...
  fastMode?: boolean;  // Fast Mode — faster Opus output, higher cost per token
